...
var logger = new ethers_1.ethers.utils.Logger("ethers-ledger/1.0.4");
var hw_app_eth_1 = __importDefault(require("@ledgerhq/hw-app-eth"));
var ledger_1 = __importDefault(require("@ledgerhq/hw-app-eth/lib/services/ledger"));
...
var LedgerSigner = /** @class */ (function (_super) {
    ...
    function LedgerSigner(provider, path) {
        ...
        var transport = ledger_transport_1.transports.hid;
        if (!transport) {
            logger.throwError("transports.hid is null/undefined");
        }
    ...
    LedgerSigner.prototype.signTransaction = function (transaction) {
        return __awaiter(this, void 0, void 0, function () {
            var tx, baseTx, unsignedTx, loadConfig, resolutionConfig, resolution, sig;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, ledger_1.default.resolveTransaction(unsignedTx, loadConfig, resolutionConfig)];
                    case 2:
                        resolution = _a.sent();
                        return [4 /*yield*/, this._retry(function (eth) { return eth.signTransaction(_this.path, unsignedTx, resolution); })];
                    case 3:
                        sig = _a.sent();
